...
const Timeline = () => {
  ...
  return (
    <section
      id="section_timeline"
      className="relative min-h-screen py-20 pb-10 px-5"
    >
      <Container>
          ...
          <div className="w-full max-w-[500px] md:max-w-[670px] flex flex-col gap-0 items-start mt-10">
            <div className="timeline_card">
              <div className="w-full max-w-[270px] md:max-w-[350px] p-5 rounded-lg bg-gradient-to-br from-[rgba(81,66,199,0.25)] to-transparent text-white text-opacity-80 font-normal flex flex-col gap-0 border-[2px] border-primary border-opacity-70">
                ...
                <p className="text-xs font-thin">
                  Got into tech stuffs through learning video editing and making
                  YouTube videos.
                </p>
              </div>
            </div>
            ...
            <div className="timeline_card">
              <div className="w-full max-w-[270px] md:max-w-[350px] p-5 rounded-lg bg-gradient-to-br from-[rgba(81,66,199,0.25)] to-transparent text-white text-opacity-80 font-normal flex flex-col gap-0 border-[2px] border-primary border-opacity-70">
                ...
                <p className="text-xs font-thin">
                  Learnt basic HTML CSS and JS from YT tutorials, later through
                  a premium course.
                </p>
              </div>
            </div>
            ...
            <div className="timeline_card">
              <div className="w-full max-w-[270px] md:max-w-[350px] p-5 rounded-lg bg-gradient-to-br from-[rgba(81,66,199,0.25)] to-transparent text-white text-opacity-80 font-normal flex flex-col gap-0 border-[2px] border-primary border-opacity-70">
                ...
                <p className="text-xs font-thin">
                  Mastered JS through problem solving and building advanced web
                  apps without any framework.
                </p>
              </div>
            </div>
            <div className="self-end timeline_card origin-top">
            ...
            <div className="timeline_card">
              <div className="w-full max-w-[270px] md:max-w-[350px] p-5 rounded-lg bg-gradient-to-br from-[rgba(81,66,199,0.25)] to-transparent text-white text-opacity-80 font-normal flex flex-col gap-0 border-[2px] border-primary border-opacity-70">
                ...
                <p className="text-xs font-thin">
                  Got hired to develop a React based online portal system for an
                  educational agency. Earned my first ever earning from this
                  project.
                </p>
              </div>
            </div>
      ...
      <Decor_BG_Circle
        className={`-bottom-[20vw] left-[50%] -translate-x-[50%] w-[80vw] blur-[35vw] md:blur-[18vw] md:w-[45vw]`}
      />
    </section>
  );
};
